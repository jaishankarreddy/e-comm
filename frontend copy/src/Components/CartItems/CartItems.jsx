...
import remove_icon2 from '../Assets/remove_icon2.png'
...
const CartItems = () => {
    ...
    return (
        <div className='cartitems'>
            <div className='cart_heading'><h1>Cart</h1></div>
                ...
                <div className="cartitems-total">
                    ...
                    <div>
                        <div className="cartitems-total-items">
                            <p>Subtotal</p>
                            <p><span>Rs.</span>{getTotalCartAmount()}</p>
                        </div>
                        <hr />
                        <div className='cartitems-total-items'>
                            <p>Shipping Fee</p>
                        ...
                        <div className="cartitems-total-items">
                            <h3>Total</h3>
                            <h3><span>Rs.</span>{getTotalCartAmount()}</h3>
                        </div>
                    </div>
